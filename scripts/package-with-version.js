...
async function main() {
  try {
    ...
    // 询问是否要递增版本
    const shouldIncrement = await askQuestion(
      "是否要递增版本号？(y/n，默认 y): "
    );
    ...
    execSync(
      "vsce package --baseContentUrl https://gitee.com --baseImagesUrl https://gitee.com/odinsam/debug-window/raw/feature/1.0.0.beta",
